...
const connectMongo = async () => {
  ...
  try {
    ...
    if (err.code === 'ECONNREFUSED' && uri.startsWith('mongodb+srv://')) {
      console.error('❌ MongoDB SRV lookup failed. Use a direct connection string in .env instead of mongodb+srv://');
      console.error('   Atlas → Connect → Drivers → copy the "Standard connection string" format.');
    }
