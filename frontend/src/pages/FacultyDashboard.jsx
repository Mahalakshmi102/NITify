...
function FacultyDashboard() {
  ...
  const isClassAdvisor = user?.classAdvisorDetails?.isClassAdvisor || false;
  ...
  const handleStartCustomSession = async (e) => {
    e.preventDefault();
    const { classKey, date } = attendanceForm;
    if (!classKey || !date) {
      alert('Please select class and date to start the attendance window.');
      return;
    }
              ...
              <div className="space-y-6">
                ...
                {!activeSession && (
                  <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-6">
                    ...
                    <form onSubmit={handleStartCustomSession} className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-semibold text-slate-500 items-end">
                      ...
                      <div className="flex flex-col">
                        ...
                        <input 
                          ...
                          className="border border-slate-200 rounded-xl p-2.5 outline-none focus:border-indigo-500 bg-white text-slate-800"
                        />
                      </div>

                      <button type="submit" className="py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-extrabold uppercase transition shadow-md shadow-indigo-100 flex items-center justify-center gap-1.5 h-[42px]">
