    ...
    if (storedToken && storedUser) {
      try {
        ...
        axios.get(apiUrl('/api/auth/profile'), {
          ...
          if (res.data) {
            const updatedUser = res.data.role === 'Parent'
              ? {
                  id: res.data.id || res.data.studentId,
                  name: res.data.linkedStudent?.name ? `Parent of ${res.data.linkedStudent.name}` : 'Parent',
                  role: 'Parent',
                  studentId: res.data.studentId,
                  linkedStudent: res.data.linkedStudent,
                  isFirstLogin: false
                }
              : {
